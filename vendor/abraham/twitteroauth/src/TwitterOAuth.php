...
class TwitterOAuth extends Config
{
    ...
    public HmacSha1 $signatureMethod;
     ...
     */
    public function resetAttemptsNumber(): void
    {
        $this->attempts = 0;
    }
     ...
     */
    public function sleepIfNeeded(): void
    {
     ...
     * @return array|object
     */
    public function uploadMediaNotChunked(string $path, array $parameters)
    {
        if (
     ...
     * @return array|object
     */
    public function uploadMediaChunked(string $path, array $parameters)
    {
        $init = $this->http(
            'POST',
            self::UPLOAD_HOST,
     ...
     * @return array
     */
    public function mediaInitParameters(array $parameters): array
    {
        $allowed_keys = [
            'media_type',
            'additional_owners',
     ...
     * @return array
     */
    public function cleanUpParameters(array $parameters)
    {
     ...
     * @return string
     */
    public function encodeAppAuthorization(Consumer $consumer): string
    {
     ...
     * @return int
     */
    public function curlCaOpt(string $path): int
    {
     ...
     * @return array
     */
    public function setPostfieldsOptions(
        array $options,
        array $postfields,
        bool $json
    ): array {
